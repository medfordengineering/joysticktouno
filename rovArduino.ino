//OVERALL YOU NEED TO USE ARRAYS AND LOOPS. YOU NEED TO REMOVE ALL I2C AND
//JUST USE SERIAL. YOUR BATTERY CONVERSION FUNCTIONS SHOULD BE A SEPARATE
//FUNCTION. THE ENTIRE CODE FILE SHOULD BE LESS THAN 100 LINES.
