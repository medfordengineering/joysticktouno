//OVERALL YOU NEED TO REMOVE THE GAME CODE FROM THIS FILE AND NEED TO TAKE
//ADVANTAGE OF LISTS. THERE IS A FAIR AMOUNT OF REDUNANCY. THE ENTIRE FILE,
//MINUS GUI CODE SHOULD BE NO MORE THAN 70 LINES
...
//REMOVE ALL GUI THAT IS NOT NECESARRY TO THE ROV. YOU CAN CREATE A
//SEPARATE FILE FOR YOUR GAME
display_width = 800
display_height = 600
...
//THESE VARIABLES SHOULD BE IN LISTS, IE ONE LIST FOR TEMPERATURES AND ONE
//LIST FOR BATTERY VOLTAGES. THESE SHOULD NOT BE GLOBAL
def ROV_values():
    global status
    global temp1
    global temp2
...
//GATHER ALL YOUR DATA IN LISTS. THIS CAN BE DONE IN THE WHILE LOOP
    for x in range(0, 35):
        print (y) 
...
//THESE SHOULD BE STORED IN LISTS AND NOT GLOBAL
    global leftvert
    global rightvert
    global righthorz
    global button1
...
//BUTTON AND JOYSTICK DATA SHOULD BE GATHERED IN TWO LOOPS EACH USING LISTS
...
//ALL JOYSTICK VALUE CONVERSIONS SHOULD BE DONE IN SEPARATE FUNCTION
	...
	//THERE IS NO REASON TO SEND TWO REQUESTS TO THE SERVER
